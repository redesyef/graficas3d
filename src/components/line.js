require(["plotly"], function (Plotly) {
  ...
  if (document.getElementById("a526a842-4b4f-4846-b121-900b3a2c5178")) {
    Plotly.newPlot(
      "a526a842-4b4f-4846-b121-900b3a2c5178",
      [
        {
          hovertemplate:
            "species=setosa<br>sepal_length=%{x}<br>sepal_width=%{y}<br>petal_width=%{z}<extra></extra>",
          legendgroup: "setosa",
        ...
        {
          hovertemplate:
            "species=versicolor<br>sepal_length=%{x}<br>sepal_width=%{y}<br>petal_width=%{z}<extra></extra>",
        ...
        {
          hovertemplate:
            "species=virginica<br>sepal_length=%{x}<br>sepal_width=%{y}<br>petal_width=%{z}<extra></extra>",
      ...
      var gd = document.getElementById("a526a842-4b4f-4846-b121-900b3a2c5178");
